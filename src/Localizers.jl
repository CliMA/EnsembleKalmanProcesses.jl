...
"""
Morzfeld, Vishny et al. (2024)
"""
struct SECNice{FT <: Real} <: LocalizationMethod
    "number of samples to approximate the std of correlation distribution (default 10^3)"
    n_samples::Int
    "scaling for discrepancy principle for ug correlation"
    tol_ug::FT
