...
x_spun_up = lorenz_solve(forcing, x_initial, picking_initial_condition) # spinning up Lorenz system
...
y = lorenz_forward(true_parameters, x0, lorenz_config_settings, observation_config) # synthetic data
