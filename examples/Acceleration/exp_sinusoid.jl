# # [Fitting parameters of an exponential sinusoid function](@id exp-sin-example)
...
prior_targeted = combine_distributions([prior_u1, prior_u2])
...
# to best interpret. Note we do not explicitly penalize distance from the prior here.
function cost(theta)
...
for (prior, prior_name, ylim) in [
    ...
    (prior_targeted, "true center [1,0.8]", (-7.5, 4.5)),
]
