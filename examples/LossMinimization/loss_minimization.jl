...
prior_u1 = Dict("distribution" => Parameterized(Normal(0, 1)),
                "constraints" => no_constraint(),
                "name" => "u1")
prior_u2 = Dict("distribution" => Parameterized(Normal(0, 1)),
                "constraints" => no_constraint(),
                "name" => "u2")
...
prior_u1 = Dict("distribution" => Parameterized(Normal(-0.5, sqrt(2))),
                "constraints" => no_constraint(),
                "name" => "u1")
prior_u2 = Dict("distribution" =>  Parameterized(Normal(0, sqrt(2))),
                "constraints" => no_constraint(),
                "name" => "u2")
